...
class FlickrAdmin 
{
	...
	function SettingsPage() 
	{
		...
		$imageSizes = array(
							"square" => __('square', 'flickr-manager') 
							,"thumbnail" => __('thumbnail', 'flickr-manager') 
							,"small" => __('small', 'flickr-manager')
							,"medium" => __('medium', 'flickr-manager')
							,"medium_640" => __('medium_640', 'flickr-manager')
							,"large" => __('large', 'flickr-manager')
							,"original" => __('original', 'flickr-manager')
						);
...
//										),
										...
										array(
											'label' => __('Default image size', 'flickr-manager')
											,'name' => 'imagesize_default'
											,'type' => 'select'
											,'param' => $imageSizes
										),
										array(
											'label' => __('Streamlined media panel', 'flickr-manager')
											,'name' => 'streamlined_enable'
											,'type' => 'checkbox'
										),
									))
			)
